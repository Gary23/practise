...
/*m/template/w_chaofan/inc/js/jquery.js*/
/*
...
/*m/template/w_chaofan/inc/js/jquery.lazyload.js*/
...
/*m/template/w_chaofan/inc/js/iscroll.js*/
// JavaScript Document
function sousuo() {
    var v = $('#keywords').val()
    if (v == '') {
...
function backToTop(pageW) {
    ...
    pageW = pageW || 0;
    var w = jisuanW(pageW);
    var $backToTopEle = $('<div class="go_top" id="backToTop"></div>').appendTo($("body")).click(function () {
...
/*m/template/w_chaofan/inc/js/fun.js*/
...
/*m/template/w_chaofan/inc/js/base64.js*/
/**
